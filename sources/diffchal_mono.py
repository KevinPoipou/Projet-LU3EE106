...
class Resolution_mono :
    ...
    def diffusion_chaleur_fil_homogene(self, fil : Fil_homogene, r: Source_de_chaleur_mono):
        """
        @param1 : self
        ...
        for t in range(0, self.dimt-1, 1):  #t
            ...
            for x in range(1, self.dimx-1, 1): #x
                ...
                F = r.M_T[t, x] * c                             # Fonction f(x, t) au point en x au temps t
    ...
    def plot_crepe(self) :
        ...
        plt.colorbar(im, ax=ax, label = 'Temperature', ticks=np.linspace(self.Tmin, self.Tmax, 10), format='%.8f') #Affiche une bar de couleur
